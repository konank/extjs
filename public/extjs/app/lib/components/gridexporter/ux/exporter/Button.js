...
Ext.define("Ext.ux.exporter.Button", {
    ...
    html: '<p></p>',
    config: {
        swfPath: ''+PathUrl+'public/extjs/app/lib/components/gridexporter/ux/exporter/downloadify.swf',
        downloadImage: ''+PathUrl+'public/extjs/app/lib/components/gridexporter/ux/exporter/download2.png',
        width: 62,
        height: 22,
