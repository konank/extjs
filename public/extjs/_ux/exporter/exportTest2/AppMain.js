Ext.onReady(function(){
	 ...
	 Ext.Loader.setPath('Ext.ux.exporter', 'app/lib/components/gridexporter/ux/exporter');
...
Ext.application({
    ...
    launch: function() {
    	...
    	console.log('CREATING GRID PORT...');
    ...
    /*    var exportButton = new Ext.ux.Exporter.Button({
      ...
      //  grid.getTopToolbar().add(exportButton);//exporterbutton
    	...
    	//Ext.create('SCM.app.lib.components.Viewport', {
