						...
						items:[
								{
									...
									items: [{
										...
										items:[{
												...
												html	:'<select id="available_user" style="border:1px solid #FFFFFF; width:240px ; height:220px"    class="formpk"    multiple="MULTIPLE">'+' <?php echo $available_user; ?></select>'
										}]
									}]
								},
								{
								...
								},
								{
									...
									items: [{
										...
										items:[{
											style	:'text-align:center',
											html	:'<select id="authorized_user" style="border:1px solid #FFFFFF; width:240px; height:220px"   class="formpk"   multiple="MULTIPLE">'+'<?php echo $authuser; ?></select>'
										}]
									}]
								}
							],
